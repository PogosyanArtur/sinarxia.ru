...
<div>             
    <div class="border  text-accent-main m-0 p-4 font-weight-bold rounded-top h5 text-center">
        Цена 
    ...
    <div class="bg-primary-main rounded-bottom text-common-white font-italic text-center m-0 p-2"> в том числе НДС 20% </div>
</div>